...
/*************************************************************/
#define VDP_VRMP5(X, Y) (msx_VRAM + ((Y&1023)<<7) + ((X&255)>>1))
#define VDP_VRMP6(X, Y) (msx_VRAM + ((Y&1023)<<7) + ((X&511)>>2))
#define VDP_VRMP7(X, Y) (msx_VRAM + ((Y&511)<<8) + ((X&511)>>1))
#define VDP_VRMP8(X, Y) (msx_VRAM + ((Y&511)<<8) + (X&255))

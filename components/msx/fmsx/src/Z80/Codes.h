...
case ADD_xHL:  I=msx_RdZ80(R->HL.W);M_ADD(I);break;
...
case SUB_xHL:  I=msx_RdZ80(R->HL.W);M_SUB(I);break;
...
case AND_xHL:  I=msx_RdZ80(R->HL.W);M_AND(I);break;
...
case OR_xHL:   I=msx_RdZ80(R->HL.W);M_OR(I);break;
...
case ADC_xHL:  I=msx_RdZ80(R->HL.W);M_ADC(I);break;
...
case SBC_xHL:  I=msx_RdZ80(R->HL.W);M_SBC(I);break;
...
case XOR_xHL:  I=msx_RdZ80(R->HL.W);M_XOR(I);break;
...
case CP_xHL:   I=msx_RdZ80(R->HL.W);M_CP(I);break;
...
case DEC_xHL:  I=msx_RdZ80(R->HL.W);M_DEC(I);msx_WrZ80(R->HL.W,I);break;
...
case INC_xHL:  I=msx_RdZ80(R->HL.W);M_INC(I);msx_WrZ80(R->HL.W,I);break;
...
case LD_xHL_B: msx_WrZ80(R->HL.W,R->BC.B.h);break;
...
case LD_xHL_C: msx_WrZ80(R->HL.W,R->BC.B.l);break;
...
case LD_xHL_D: msx_WrZ80(R->HL.W,R->DE.B.h);break;
...
case LD_xHL_E: msx_WrZ80(R->HL.W,R->DE.B.l);break;
...
case LD_xHL_H: msx_WrZ80(R->HL.W,R->HL.B.h);break;
...
case LD_xHL_L: msx_WrZ80(R->HL.W,R->HL.B.l);break;
...
case LD_xHL_A: msx_WrZ80(R->HL.W,R->AF.B.h);break;

case LD_xBC_A: msx_WrZ80(R->BC.W,R->AF.B.h);break;
case LD_xDE_A: msx_WrZ80(R->DE.W,R->AF.B.h);break;

case LD_B_xHL:    R->BC.B.h=msx_RdZ80(R->HL.W);break;
case LD_C_xHL:    R->BC.B.l=msx_RdZ80(R->HL.W);break;
case LD_D_xHL:    R->DE.B.h=msx_RdZ80(R->HL.W);break;
case LD_E_xHL:    R->DE.B.l=msx_RdZ80(R->HL.W);break;
...
case LD_xHL_BYTE: msx_WrZ80(R->HL.W,OpZ80(R->PC.W++));break;
...
case EX_HL_xSP:
  J.B.l=msx_RdZ80(R->SP.W);msx_WrZ80(R->SP.W++,R->HL.B.l);
  J.B.h=msx_RdZ80(R->SP.W);msx_WrZ80(R->SP.W--,R->HL.B.h);
  R->HL.W=J.W;
  break;

...
/*************************************************************/
void msx_ResetZ80(register Z80 *R);
...
/*************************************************************/
void msx_IntZ80(register Z80 *R,register word Vector);
...
void msx_WrZ80(register word Addr,register byte Value);
byte msx_RdZ80(register word Addr);
...
/************************************ TO BE WRITTEN BY USER **/
void msx_OutZ80(register word Port,register byte Value);
byte msx_InZ80(register word Port);
...
/************************************ TO BE WRITTEN BY USER **/
word msx_LoopZ80(register Z80 *R);

...
case RRC_xHL: I=msx_RdZ80(R->HL.W);M_RRC(I);msx_WrZ80(R->HL.W,I);break;
...
case RL_xHL: I=msx_RdZ80(R->HL.W);M_RL(I);msx_WrZ80(R->HL.W,I);break;
...
case RR_xHL: I=msx_RdZ80(R->HL.W);M_RR(I);msx_WrZ80(R->HL.W,I);break;
...
case SLA_xHL: I=msx_RdZ80(R->HL.W);M_SLA(I);msx_WrZ80(R->HL.W,I);break;
...
case SRA_xHL: I=msx_RdZ80(R->HL.W);M_SRA(I);msx_WrZ80(R->HL.W,I);break;
...
case SLL_xHL: I=msx_RdZ80(R->HL.W);M_SLL(I);msx_WrZ80(R->HL.W,I);break;
...
case SRL_xHL: I=msx_RdZ80(R->HL.W);M_SRL(I);msx_WrZ80(R->HL.W,I);break;
...
case BIT0_xHL: I=msx_RdZ80(R->HL.W);M_BIT(0,I);break;
...
case BIT1_xHL: I=msx_RdZ80(R->HL.W);M_BIT(1,I);break;
...
case BIT2_xHL: I=msx_RdZ80(R->HL.W);M_BIT(2,I);break;
...
case BIT3_xHL: I=msx_RdZ80(R->HL.W);M_BIT(3,I);break;
...
case BIT4_xHL: I=msx_RdZ80(R->HL.W);M_BIT(4,I);break;
...
case BIT5_xHL: I=msx_RdZ80(R->HL.W);M_BIT(5,I);break;
...
case BIT6_xHL: I=msx_RdZ80(R->HL.W);M_BIT(6,I);break;
...
case BIT7_xHL: I=msx_RdZ80(R->HL.W);M_BIT(7,I);break;
...
case RES0_xHL: I=msx_RdZ80(R->HL.W);M_RES(0,I);msx_WrZ80(R->HL.W,I);break;
...
case RES1_xHL: I=msx_RdZ80(R->HL.W);M_RES(1,I);msx_WrZ80(R->HL.W,I);break;
...
case RES2_xHL: I=msx_RdZ80(R->HL.W);M_RES(2,I);msx_WrZ80(R->HL.W,I);break;
...
case RES3_xHL: I=msx_RdZ80(R->HL.W);M_RES(3,I);msx_WrZ80(R->HL.W,I);break;
...
case RES4_xHL: I=msx_RdZ80(R->HL.W);M_RES(4,I);msx_WrZ80(R->HL.W,I);break;
...
case RES5_xHL: I=msx_RdZ80(R->HL.W);M_RES(5,I);msx_WrZ80(R->HL.W,I);break;
...
case RES6_xHL: I=msx_RdZ80(R->HL.W);M_RES(6,I);msx_WrZ80(R->HL.W,I);break;
...
case RES7_xHL: I=msx_RdZ80(R->HL.W);M_RES(7,I);msx_WrZ80(R->HL.W,I);break;
...
case SET0_xHL: I=msx_RdZ80(R->HL.W);M_SET(0,I);msx_WrZ80(R->HL.W,I);break;
...
case SET1_xHL: I=msx_RdZ80(R->HL.W);M_SET(1,I);msx_WrZ80(R->HL.W,I);break;
...
case SET2_xHL: I=msx_RdZ80(R->HL.W);M_SET(2,I);msx_WrZ80(R->HL.W,I);break;
...
case SET3_xHL: I=msx_RdZ80(R->HL.W);M_SET(3,I);msx_WrZ80(R->HL.W,I);break;
...
case SET4_xHL: I=msx_RdZ80(R->HL.W);M_SET(4,I);msx_WrZ80(R->HL.W,I);break;
...
case SET5_xHL: I=msx_RdZ80(R->HL.W);M_SET(5,I);msx_WrZ80(R->HL.W,I);break;
...
case SET6_xHL: I=msx_RdZ80(R->HL.W);M_SET(6,I);msx_WrZ80(R->HL.W,I);break;
...
case SET7_xHL: I=msx_RdZ80(R->HL.W);M_SET(7,I);msx_WrZ80(R->HL.W,I);break;

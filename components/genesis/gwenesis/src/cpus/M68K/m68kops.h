...
{
  uint32 src = OPER_AY_PD_8();
  uint32 ea  = EA_A7_PD_8();
  uint32 dst = m68ki_read_8(ea);
  uint32 res = LOW_NIBBLE(src) + LOW_NIBBLE(dst) + XFLAG_AS_1();
  uint32 corf = 0;
...
{
  uint32 src = OPER_A7_PD_8();
  uint32 ea  = EA_AX_PD_8();
  uint32 dst = m68ki_read_8(ea);
  uint32 res = LOW_NIBBLE(src) + LOW_NIBBLE(dst) + XFLAG_AS_1();
  uint32 corf = 0;
...
{
  uint32* r_dst = &AX;
  uint32 src = MAKE_INT_16(OPER_AY_AI_16());
...
{
  uint32* r_dst = &AX;
  uint32 src = MAKE_INT_16(OPER_AY_PI_16());
...
{
  uint32* r_dst = &AX;
  uint32 src = MAKE_INT_16(OPER_AY_PD_16());
...
{
  uint32* r_dst = &AX;
  uint32 src = MAKE_INT_16(OPER_AY_DI_16());
...
{
  uint32* r_dst = &AX;
  uint32 src = MAKE_INT_16(OPER_AY_IX_16());
...
{
  uint32* r_dst = &AX;
  uint32 src = MAKE_INT_16(OPER_AW_16());
...
{
  uint32* r_dst = &AX;
  uint32 src = MAKE_INT_16(OPER_AL_16());
...
{
  uint32* r_dst = &AX;
  uint32 src = MAKE_INT_16(OPER_PCDI_16());
...
{
  uint32* r_dst = &AX;
  uint32 src = MAKE_INT_16(OPER_PCIX_16());
...
{
  uint32* r_dst = &AX;
  uint32 src = MAKE_INT_16(OPER_I_16());
...
{
  uint32 ea = EA_AY_AI_16();
  uint32 res = DX & m68ki_read_16(ea);
...
{
  uint32 ea = EA_AY_AI_32();
  uint32 res = DX & m68ki_read_32(ea);
...
static void m68k_op_andi_8_ai(void)
{
  uint32 src = OPER_I_8();
  uint32 ea = EA_AY_AI_8();
  uint32 res = src & m68ki_read_8(ea);
...
static void m68k_op_andi_16_ai(void)
{
  uint32 src = OPER_I_16();
  uint32 ea = EA_AY_AI_16();
  uint32 res = src & m68ki_read_16(ea);
...
static void m68k_op_andi_32_ai(void)
{
  uint32 src = OPER_I_32();
  uint32 ea = EA_AY_AI_32();
  uint32 res = src & m68ki_read_32(ea);
...
{
  uint32 ea = EA_AY_AI_8();
  uint32 res = MASK_OUT_ABOVE_8(DX ^ m68ki_read_8(ea));
...
{
  uint32 ea = EA_AY_AI_16();
  uint32 res = MASK_OUT_ABOVE_16(DX ^ m68ki_read_16(ea));
...
{
  uint32 res = MASK_OUT_ABOVE_8(DY ^= OPER_I_8());
...
{
  uint32 res = MASK_OUT_ABOVE_16(DY ^= OPER_I_16());
...
{
  uint32 i = 0;
  uint32 register_list = OPER_I_16();
  uint32 ea = AY;
  uint32 count = 0;
...
static void m68k_op_muls_16_d(void)
{
  uint32* r_dst = &DX;
  sint src = MAKE_INT_16(DY);
  uint32 res = MASK_OUT_ABOVE_32( src * MAKE_INT_16(MASK_OUT_ABOVE_16(*r_dst)));
...
static void m68k_op_mulu_16_d(void)
{
  uint32* r_dst = &DX;
  uint32 src = MASK_OUT_ABOVE_16(DY);
  uint32 res = src * MASK_OUT_ABOVE_16(*r_dst);
...
{
  uint32 ea = EA_AY_AI_8();
  uint32 res = MASK_OUT_ABOVE_8(~m68ki_read_8(ea));
...
{
  uint32 ea = EA_AY_AI_16();
  uint32 res = MASK_OUT_ABOVE_16(~m68ki_read_16(ea));
...
{
  uint32 ea = EA_AY_AI_32();
  uint32 res = MASK_OUT_ABOVE_32(~m68ki_read_32(ea));
...
{
  uint32 res = MASK_OUT_ABOVE_8((DX |= OPER_AY_AI_8()));
...
{
  uint32 res = MASK_OUT_ABOVE_8((DX |= OPER_AY_PI_8()));
...
{
  uint32 res = MASK_OUT_ABOVE_8((DX |= OPER_A7_PI_8()));
...
{
  uint32 res = MASK_OUT_ABOVE_8((DX |= OPER_AY_PD_8()));
...
{
  uint32 res = MASK_OUT_ABOVE_8((DX |= OPER_A7_PD_8()));
...
{
  uint32 res = MASK_OUT_ABOVE_8((DX |= OPER_AY_DI_8()));
...
{
  uint32 res = MASK_OUT_ABOVE_8((DX |= OPER_AY_IX_8()));
...
{
  uint32 res = MASK_OUT_ABOVE_8((DX |= OPER_AW_8()));
...
{
  uint32 res = MASK_OUT_ABOVE_8((DX |= OPER_AL_8()));
...
{
  uint32 res = MASK_OUT_ABOVE_8((DX |= OPER_PCDI_8()));
...
{
  uint32 res = MASK_OUT_ABOVE_8((DX |= OPER_PCIX_8()));
...
{
  uint32 res = MASK_OUT_ABOVE_8((DX |= OPER_I_8()));
...
{
  uint32 res = MASK_OUT_ABOVE_16((DX |= OPER_AY_AI_16()));
...
{
  uint32 res = MASK_OUT_ABOVE_16((DX |= OPER_AY_PI_16()));
...
{
  uint32 res = MASK_OUT_ABOVE_16((DX |= OPER_AY_PD_16()));
...
{
  uint32 res = MASK_OUT_ABOVE_16((DX |= OPER_AY_DI_16()));
...
{
  uint32 res = MASK_OUT_ABOVE_16((DX |= OPER_AY_IX_16()));
...
{
  uint32 res = MASK_OUT_ABOVE_16((DX |= OPER_AW_16()));
...
{
  uint32 res = MASK_OUT_ABOVE_16((DX |= OPER_AL_16()));
...
{
  uint32 res = MASK_OUT_ABOVE_16((DX |= OPER_PCDI_16()));
...
{
  uint32 res = MASK_OUT_ABOVE_16((DX |= OPER_PCIX_16()));
...
{
  uint32 res = MASK_OUT_ABOVE_16((DX |= OPER_I_16()));
...
static void m68k_op_ori_8_ai(void)
{
  uint32 src = OPER_I_8();
  uint32 ea = EA_AY_AI_8();
  uint32 res = MASK_OUT_ABOVE_8(src | m68ki_read_8(ea));
...
static void m68k_op_ori_16_ai(void)
{
  uint32 src = OPER_I_16();
  uint32 ea = EA_AY_AI_16();
  uint32 res = MASK_OUT_ABOVE_16(src | m68ki_read_16(ea));

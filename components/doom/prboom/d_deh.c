 ...
 */
const char* const s_D_DEVSTR    = D_DEVSTR;
const char* const s_D_CDROM     = D_CDROM;
const char* const s_PRESSKEY    = PRESSKEY;
const char* const s_PRESSYN     = PRESSYN;
const char* const s_QUITMSG     = QUITMSG;
const char* const s_QSAVESPOT   = QSAVESPOT; // PRESSKEY;
const char* const s_SAVEDEAD    = SAVEDEAD;  // PRESSKEY; // remove duplicate y/n
const char* const s_QSPROMPT    = QSPROMPT;  // PRESSYN;
const char* const s_QLPROMPT    = QLPROMPT;  // PRESSYN;
const char* const s_NEWGAME     = NEWGAME;   // PRESSKEY;
const char* const s_RESTARTLEVEL= RESTARTLEVEL; // PRESSYN;
const char* const s_NIGHTMARE   = NIGHTMARE; // PRESSYN;
const char* const s_SWSTRING    = SWSTRING;  // PRESSKEY;
const char* const s_MSGOFF      = MSGOFF;
const char* const s_MSGON       = MSGON;
const char* const s_NETEND      = NETEND;    // PRESSKEY;
const char* const s_ENDGAME     = ENDGAME;   // PRESSYN; // killough 4/4/98: end
const char* const s_DOSY        = DOSY;
const char* const s_DETAILHI    = DETAILHI;
const char* const s_DETAILLO    = DETAILLO;
const char* const s_GAMMALVL0   = GAMMALVL0;
const char* const s_GAMMALVL1   = GAMMALVL1;
const char* const s_GAMMALVL2   = GAMMALVL2;
const char* const s_GAMMALVL3   = GAMMALVL3;
const char* const s_GAMMALVL4   = GAMMALVL4;
const char* const s_EMPTYSTRING = EMPTYSTRING;
const char* const s_GOTARMOR    = GOTARMOR;
const char* const s_GOTMEGA     = GOTMEGA;
const char* const s_GOTHTHBONUS = GOTHTHBONUS;
const char* const s_GOTARMBONUS = GOTARMBONUS;
const char* const s_GOTSTIM     = GOTSTIM;
const char* const s_GOTMEDINEED = GOTMEDINEED;
const char* const s_GOTMEDIKIT  = GOTMEDIKIT;
const char* const s_GOTSUPER    = GOTSUPER;
const char* const s_GOTBLUECARD = GOTBLUECARD;
const char* const s_GOTYELWCARD = GOTYELWCARD;
const char* const s_GOTREDCARD  = GOTREDCARD;
const char* const s_GOTBLUESKUL = GOTBLUESKUL;
const char* const s_GOTYELWSKUL = GOTYELWSKUL;
const char* const s_GOTREDSKULL = GOTREDSKULL;
const char* const s_GOTINVUL    = GOTINVUL;
const char* const s_GOTBERSERK  = GOTBERSERK;
const char* const s_GOTINVIS    = GOTINVIS;
const char* const s_GOTSUIT     = GOTSUIT;
const char* const s_GOTMAP      = GOTMAP;
const char* const s_GOTVISOR    = GOTVISOR;
const char* const s_GOTMSPHERE  = GOTMSPHERE;
const char* const s_GOTCLIP     = GOTCLIP;
const char* const s_GOTCLIPBOX  = GOTCLIPBOX;
const char* const s_GOTROCKET   = GOTROCKET;
const char* const s_GOTROCKBOX  = GOTROCKBOX;
const char* const s_GOTCELL     = GOTCELL;
const char* const s_GOTCELLBOX  = GOTCELLBOX;
const char* const s_GOTSHELLS   = GOTSHELLS;
const char* const s_GOTSHELLBOX = GOTSHELLBOX;
const char* const s_GOTBACKPACK = GOTBACKPACK;
const char* const s_GOTBFG9000  = GOTBFG9000;
const char* const s_GOTCHAINGUN = GOTCHAINGUN;
const char* const s_GOTCHAINSAW = GOTCHAINSAW;
const char* const s_GOTLAUNCHER = GOTLAUNCHER;
const char* const s_GOTPLASMA   = GOTPLASMA;
const char* const s_GOTSHOTGUN  = GOTSHOTGUN;
const char* const s_GOTSHOTGUN2 = GOTSHOTGUN2;
const char* const s_PD_BLUEO    = PD_BLUEO;
const char* const s_PD_REDO     = PD_REDO;
const char* const s_PD_YELLOWO  = PD_YELLOWO;
const char* const s_PD_BLUEK    = PD_BLUEK;
const char* const s_PD_REDK     = PD_REDK;
const char* const s_PD_YELLOWK  = PD_YELLOWK;
const char* const s_PD_BLUEC    = PD_BLUEC;
const char* const s_PD_REDC     = PD_REDC;
const char* const s_PD_YELLOWC  = PD_YELLOWC;
const char* const s_PD_BLUES    = PD_BLUES;
const char* const s_PD_REDS     = PD_REDS;
const char* const s_PD_YELLOWS  = PD_YELLOWS;
const char* const s_PD_ANY      = PD_ANY;
const char* const s_PD_ALL3     = PD_ALL3;
const char* const s_PD_ALL6     = PD_ALL6;
const char* const s_GGSAVED     = GGSAVED;
const char* const s_HUSTR_MSGU  = HUSTR_MSGU;
const char* const s_HUSTR_E1M1  = HUSTR_E1M1;
const char* const s_HUSTR_E1M2  = HUSTR_E1M2;
const char* const s_HUSTR_E1M3  = HUSTR_E1M3;
const char* const s_HUSTR_E1M4  = HUSTR_E1M4;
const char* const s_HUSTR_E1M5  = HUSTR_E1M5;
const char* const s_HUSTR_E1M6  = HUSTR_E1M6;
const char* const s_HUSTR_E1M7  = HUSTR_E1M7;
const char* const s_HUSTR_E1M8  = HUSTR_E1M8;
const char* const s_HUSTR_E1M9  = HUSTR_E1M9;
const char* const s_HUSTR_E2M1  = HUSTR_E2M1;
const char* const s_HUSTR_E2M2  = HUSTR_E2M2;
const char* const s_HUSTR_E2M3  = HUSTR_E2M3;
const char* const s_HUSTR_E2M4  = HUSTR_E2M4;
const char* const s_HUSTR_E2M5  = HUSTR_E2M5;
const char* const s_HUSTR_E2M6  = HUSTR_E2M6;
const char* const s_HUSTR_E2M7  = HUSTR_E2M7;
const char* const s_HUSTR_E2M8  = HUSTR_E2M8;
const char* const s_HUSTR_E2M9  = HUSTR_E2M9;
const char* const s_HUSTR_E3M1  = HUSTR_E3M1;
const char* const s_HUSTR_E3M2  = HUSTR_E3M2;
const char* const s_HUSTR_E3M3  = HUSTR_E3M3;
const char* const s_HUSTR_E3M4  = HUSTR_E3M4;
const char* const s_HUSTR_E3M5  = HUSTR_E3M5;
const char* const s_HUSTR_E3M6  = HUSTR_E3M6;
const char* const s_HUSTR_E3M7  = HUSTR_E3M7;
const char* const s_HUSTR_E3M8  = HUSTR_E3M8;
const char* const s_HUSTR_E3M9  = HUSTR_E3M9;
const char* const s_HUSTR_E4M1  = HUSTR_E4M1;
const char* const s_HUSTR_E4M2  = HUSTR_E4M2;
const char* const s_HUSTR_E4M3  = HUSTR_E4M3;
const char* const s_HUSTR_E4M4  = HUSTR_E4M4;
const char* const s_HUSTR_E4M5  = HUSTR_E4M5;
const char* const s_HUSTR_E4M6  = HUSTR_E4M6;
const char* const s_HUSTR_E4M7  = HUSTR_E4M7;
const char* const s_HUSTR_E4M8  = HUSTR_E4M8;
const char* const s_HUSTR_E4M9  = HUSTR_E4M9;
const char* const s_HUSTR_1     = HUSTR_1;
const char* const s_HUSTR_2     = HUSTR_2;
const char* const s_HUSTR_3     = HUSTR_3;
const char* const s_HUSTR_4     = HUSTR_4;
const char* const s_HUSTR_5     = HUSTR_5;
const char* const s_HUSTR_6     = HUSTR_6;
const char* const s_HUSTR_7     = HUSTR_7;
const char* const s_HUSTR_8     = HUSTR_8;
const char* const s_HUSTR_9     = HUSTR_9;
const char* const s_HUSTR_10    = HUSTR_10;
const char* const s_HUSTR_11    = HUSTR_11;
const char* const s_HUSTR_12    = HUSTR_12;
const char* const s_HUSTR_13    = HUSTR_13;
const char* const s_HUSTR_14    = HUSTR_14;
const char* const s_HUSTR_15    = HUSTR_15;
const char* const s_HUSTR_16    = HUSTR_16;
const char* const s_HUSTR_17    = HUSTR_17;
const char* const s_HUSTR_18    = HUSTR_18;
const char* const s_HUSTR_19    = HUSTR_19;
const char* const s_HUSTR_20    = HUSTR_20;
const char* const s_HUSTR_21    = HUSTR_21;
const char* const s_HUSTR_22    = HUSTR_22;
const char* const s_HUSTR_23    = HUSTR_23;
const char* const s_HUSTR_24    = HUSTR_24;
const char* const s_HUSTR_25    = HUSTR_25;
const char* const s_HUSTR_26    = HUSTR_26;
const char* const s_HUSTR_27    = HUSTR_27;
const char* const s_HUSTR_28    = HUSTR_28;
const char* const s_HUSTR_29    = HUSTR_29;
const char* const s_HUSTR_30    = HUSTR_30;
const char* const s_HUSTR_31    = HUSTR_31;
const char* const s_HUSTR_32    = HUSTR_32;
const char* const s_PHUSTR_1    = PHUSTR_1;
const char* const s_PHUSTR_2    = PHUSTR_2;
const char* const s_PHUSTR_3    = PHUSTR_3;
const char* const s_PHUSTR_4    = PHUSTR_4;
const char* const s_PHUSTR_5    = PHUSTR_5;
const char* const s_PHUSTR_6    = PHUSTR_6;
const char* const s_PHUSTR_7    = PHUSTR_7;
const char* const s_PHUSTR_8    = PHUSTR_8;
const char* const s_PHUSTR_9    = PHUSTR_9;
const char* const s_PHUSTR_10   = PHUSTR_10;
const char* const s_PHUSTR_11   = PHUSTR_11;
const char* const s_PHUSTR_12   = PHUSTR_12;
const char* const s_PHUSTR_13   = PHUSTR_13;
const char* const s_PHUSTR_14   = PHUSTR_14;
const char* const s_PHUSTR_15   = PHUSTR_15;
const char* const s_PHUSTR_16   = PHUSTR_16;
const char* const s_PHUSTR_17   = PHUSTR_17;
const char* const s_PHUSTR_18   = PHUSTR_18;
const char* const s_PHUSTR_19   = PHUSTR_19;
const char* const s_PHUSTR_20   = PHUSTR_20;
const char* const s_PHUSTR_21   = PHUSTR_21;
const char* const s_PHUSTR_22   = PHUSTR_22;
const char* const s_PHUSTR_23   = PHUSTR_23;
const char* const s_PHUSTR_24   = PHUSTR_24;
const char* const s_PHUSTR_25   = PHUSTR_25;
const char* const s_PHUSTR_26   = PHUSTR_26;
const char* const s_PHUSTR_27   = PHUSTR_27;
const char* const s_PHUSTR_28   = PHUSTR_28;
const char* const s_PHUSTR_29   = PHUSTR_29;
const char* const s_PHUSTR_30   = PHUSTR_30;
const char* const s_PHUSTR_31   = PHUSTR_31;
const char* const s_PHUSTR_32   = PHUSTR_32;
const char* const s_THUSTR_1    = THUSTR_1;
const char* const s_THUSTR_2    = THUSTR_2;
const char* const s_THUSTR_3    = THUSTR_3;
const char* const s_THUSTR_4    = THUSTR_4;
const char* const s_THUSTR_5    = THUSTR_5;
const char* const s_THUSTR_6    = THUSTR_6;
const char* const s_THUSTR_7    = THUSTR_7;
const char* const s_THUSTR_8    = THUSTR_8;
const char* const s_THUSTR_9    = THUSTR_9;
const char* const s_THUSTR_10   = THUSTR_10;
const char* const s_THUSTR_11   = THUSTR_11;
const char* const s_THUSTR_12   = THUSTR_12;
const char* const s_THUSTR_13   = THUSTR_13;
const char* const s_THUSTR_14   = THUSTR_14;
const char* const s_THUSTR_15   = THUSTR_15;
const char* const s_THUSTR_16   = THUSTR_16;
const char* const s_THUSTR_17   = THUSTR_17;
const char* const s_THUSTR_18   = THUSTR_18;
const char* const s_THUSTR_19   = THUSTR_19;
const char* const s_THUSTR_20   = THUSTR_20;
const char* const s_THUSTR_21   = THUSTR_21;
const char* const s_THUSTR_22   = THUSTR_22;
const char* const s_THUSTR_23   = THUSTR_23;
const char* const s_THUSTR_24   = THUSTR_24;
const char* const s_THUSTR_25   = THUSTR_25;
const char* const s_THUSTR_26   = THUSTR_26;
const char* const s_THUSTR_27   = THUSTR_27;
const char* const s_THUSTR_28   = THUSTR_28;
const char* const s_THUSTR_29   = THUSTR_29;
const char* const s_THUSTR_30   = THUSTR_30;
const char* const s_THUSTR_31   = THUSTR_31;
const char* const s_THUSTR_32   = THUSTR_32;
const char* const s_HUSTR_CHATMACRO1   = HUSTR_CHATMACRO1;
const char* const s_HUSTR_CHATMACRO2   = HUSTR_CHATMACRO2;
const char* const s_HUSTR_CHATMACRO3   = HUSTR_CHATMACRO3;
const char* const s_HUSTR_CHATMACRO4   = HUSTR_CHATMACRO4;
const char* const s_HUSTR_CHATMACRO5   = HUSTR_CHATMACRO5;
const char* const s_HUSTR_CHATMACRO6   = HUSTR_CHATMACRO6;
const char* const s_HUSTR_CHATMACRO7   = HUSTR_CHATMACRO7;
const char* const s_HUSTR_CHATMACRO8   = HUSTR_CHATMACRO8;
const char* const s_HUSTR_CHATMACRO9   = HUSTR_CHATMACRO9;
const char* const s_HUSTR_CHATMACRO0   = HUSTR_CHATMACRO0;
const char* const s_HUSTR_TALKTOSELF1  = HUSTR_TALKTOSELF1;
const char* const s_HUSTR_TALKTOSELF2  = HUSTR_TALKTOSELF2;
const char* const s_HUSTR_TALKTOSELF3  = HUSTR_TALKTOSELF3;
const char* const s_HUSTR_TALKTOSELF4  = HUSTR_TALKTOSELF4;
const char* const s_HUSTR_TALKTOSELF5  = HUSTR_TALKTOSELF5;
const char* const s_HUSTR_MESSAGESENT  = HUSTR_MESSAGESENT;
const char* const s_HUSTR_PLRGREEN     = HUSTR_PLRGREEN;
const char* const s_HUSTR_PLRINDIGO    = HUSTR_PLRINDIGO;
const char* const s_HUSTR_PLRBROWN     = HUSTR_PLRBROWN;
const char* const s_HUSTR_PLRRED       = HUSTR_PLRRED;
const char* const s_AMSTR_FOLLOWON     = AMSTR_FOLLOWON;
const char* const s_AMSTR_FOLLOWOFF    = AMSTR_FOLLOWOFF;
const char* const s_AMSTR_GRIDON       = AMSTR_GRIDON;
const char* const s_AMSTR_GRIDOFF      = AMSTR_GRIDOFF;
const char* const s_AMSTR_MARKEDSPOT   = AMSTR_MARKEDSPOT;
const char* const s_AMSTR_MARKSCLEARED = AMSTR_MARKSCLEARED;
// CPhipps - automap rotate & overlay
const char* const s_AMSTR_ROTATEON     = AMSTR_ROTATEON;
const char* const s_AMSTR_ROTATEOFF    = AMSTR_ROTATEOFF;
const char* const s_AMSTR_OVERLAYON    = AMSTR_OVERLAYON;
const char* const s_AMSTR_OVERLAYOFF   = AMSTR_OVERLAYOFF;
const char* const s_STSTR_MUS          = STSTR_MUS;
const char* const s_STSTR_NOMUS        = STSTR_NOMUS;
const char* const s_STSTR_DQDON        = STSTR_DQDON;
const char* const s_STSTR_DQDOFF       = STSTR_DQDOFF;
const char* const s_STSTR_KFAADDED     = STSTR_KFAADDED;
const char* const s_STSTR_FAADDED      = STSTR_FAADDED;
const char* const s_STSTR_NCON         = STSTR_NCON;
const char* const s_STSTR_NCOFF        = STSTR_NCOFF;
const char* const s_STSTR_BEHOLD       = STSTR_BEHOLD;
const char* const s_STSTR_BEHOLDX      = STSTR_BEHOLDX;
const char* const s_STSTR_CHOPPERS     = STSTR_CHOPPERS;
const char* const s_STSTR_CLEV         = STSTR_CLEV;
const char* const s_STSTR_COMPON       = STSTR_COMPON;
const char* const s_STSTR_COMPOFF      = STSTR_COMPOFF;
const char* const s_E1TEXT     = E1TEXT;
const char* const s_E2TEXT     = E2TEXT;
const char* const s_E3TEXT     = E3TEXT;
const char* const s_E4TEXT     = E4TEXT;
const char* const s_C1TEXT     = C1TEXT;
const char* const s_C2TEXT     = C2TEXT;
const char* const s_C3TEXT     = C3TEXT;
const char* const s_C4TEXT     = C4TEXT;
const char* const s_C5TEXT     = C5TEXT;
const char* const s_C6TEXT     = C6TEXT;
const char* const s_P1TEXT     = P1TEXT;
const char* const s_P2TEXT     = P2TEXT;
const char* const s_P3TEXT     = P3TEXT;
const char* const s_P4TEXT     = P4TEXT;
const char* const s_P5TEXT     = P5TEXT;
const char* const s_P6TEXT     = P6TEXT;
const char* const s_T1TEXT     = T1TEXT;
const char* const s_T2TEXT     = T2TEXT;
const char* const s_T3TEXT     = T3TEXT;
const char* const s_T4TEXT     = T4TEXT;
const char* const s_T5TEXT     = T5TEXT;
const char* const s_T6TEXT     = T6TEXT;
const char* const s_CC_ZOMBIE  = CC_ZOMBIE;
const char* const s_CC_SHOTGUN = CC_SHOTGUN;
const char* const s_CC_HEAVY   = CC_HEAVY;
const char* const s_CC_IMP     = CC_IMP;
const char* const s_CC_DEMON   = CC_DEMON;
const char* const s_CC_LOST    = CC_LOST;
const char* const s_CC_CACO    = CC_CACO;
const char* const s_CC_HELL    = CC_HELL;
const char* const s_CC_BARON   = CC_BARON;
const char* const s_CC_ARACH   = CC_ARACH;
const char* const s_CC_PAIN    = CC_PAIN;
const char* const s_CC_REVEN   = CC_REVEN;
const char* const s_CC_MANCU   = CC_MANCU;
const char* const s_CC_ARCH    = CC_ARCH;
const char* const s_CC_SPIDER  = CC_SPIDER;
const char* const s_CC_CYBER   = CC_CYBER;
const char* const s_CC_HERO    = CC_HERO;
// Ty 03/30/98 - new substitutions for background textures
//               during int screens
const char* const bgflatE1     = "FLOOR4_8"; // end of DOOM Episode 1
const char* const bgflatE2     = "SFLR6_1";  // end of DOOM Episode 2
const char* const bgflatE3     = "MFLR8_4";  // end of DOOM Episode 3
const char* const bgflatE4     = "MFLR8_3";  // end of DOOM Episode 4
const char* const bgflat06     = "SLIME16";  // DOOM2 after MAP06
const char* const bgflat11     = "RROCK14";  // DOOM2 after MAP11
const char* const bgflat20     = "RROCK07";  // DOOM2 after MAP20
const char* const bgflat30     = "RROCK17";  // DOOM2 after MAP30
const char* const bgflat15     = "RROCK13";  // DOOM2 going MAP15 to MAP31
const char* const bgflat31     = "RROCK19";  // DOOM2 going MAP31 to MAP32
const char* const bgcastcall   = "BOSSBACK"; // Panel behind cast call

const char* const startup1     = "";  // blank lines are default and are not printed
const char* const startup2     = "";
const char* const startup3     = "";
const char* const startup4     = "";
const char* const startup5     = "";

// end d_deh.h variable declarations
// ====================================================================

const char* const deh_newlevel = "NEWLEVEL"; // CPhipps - const

// DOOM shareware/registered/retail (Ultimate) names.
// CPhipps - const**const
const char * const *const mapnames[] =
{
  &s_HUSTR_E1M1,
  &s_HUSTR_E1M2,
  &s_HUSTR_E1M3,
...
// CPhipps - const**const
const char * const*const mapnames2[] = // DOOM 2 map names.
{
  &s_HUSTR_1,
  &s_HUSTR_2,
  &s_HUSTR_3,
...
// CPhipps - const**const
const char * const*const mapnamesp[] = // Plutonia WAD map names.
{
  &s_PHUSTR_1,
  &s_PHUSTR_2,
  &s_PHUSTR_3,
...
// CPhipps - const**const
const char * const*const mapnamest[] = // TNT WAD map names.
{
  &s_THUSTR_1,
  &s_THUSTR_2,
  &s_THUSTR_3,
...
typedef struct {
  const char *const * ppstr;  // doubly indirect pointer to string
  const char * const lookup;  // pointer to lookup string name
} deh_strs;

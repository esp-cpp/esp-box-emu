...
// On the ESP32 the synthesizers render 16-bit integer stereo samples directly
// (no floating point mixing stage).
#ifdef TFE_ESPBOX
typedef s16 MidiSample;
#else
typedef f32 MidiSample;
#endif
...
namespace TFE_Audio
{
	...
	public:
		...
		virtual bool render(MidiSample* buffer, u32 sampleCount) = 0;
